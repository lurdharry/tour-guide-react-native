...
import { CopilotProvider, CopilotStep, walkthroughable, useCopilot } from 'tour-guide-react-native';
...
function App() {
  ...
  console.log({ copilotEvents });
  const [secondStepActive, setSecondStepActive] = useState(true);
  const [lastEvent, setLastEvent] = useState<string>();

  useEffect(() => {
    copilotEvents.on('stepChange', (step) => {
      return setLastEvent(`stepChange: ${step?.name}`);
    });
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.row}>
        ...
        <Ionicons style={styles.tabItem} name="airplane" size={25} color="#888" />
        <Ionicons style={styles.tabItem} name="ios-globe" size={25} color="#888" />
        <Ionicons style={styles.tabItem} name="ios-navigate-outline" size={25} color="#888" />
        <Ionicons style={styles.tabItem} name="ios-rainy" size={25} color="#888" />
      </View>
    </SafeAreaView>
  );
}
